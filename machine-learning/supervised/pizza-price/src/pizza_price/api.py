...
async def lifespan(app: FastAPI):
    ...
    _metrics.set_model_info(model_name="pizza-price", model_version=_model_version, model_type="regression")
    ...
    try:
        if MODEL_VERSION == "latest":
            ...
            if pizza_models:
                ...
                npz_files = list(model_dir.glob("pizza_model_*.npz")) + list(model_dir.glob("*.npz"))
                if npz_files:
