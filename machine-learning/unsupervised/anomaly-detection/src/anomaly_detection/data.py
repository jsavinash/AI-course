...
def _generate_server_metrics(
    ...
    normal = np.column_stack([
        req_base, bpr_base, cpu_base, mem_base, disk_base,
        net_in_base, net_out_base, err_base, conn_base, rt_base,
    ])
    ...
    for i, at in enumerate(anomaly_type):
        if at == 0:
            # CPU spike
            anomaly[i] = [
                rng.normal(520, 60), rng.normal(1400, 200),
                rng.normal(72, 5), rng.normal(80, 4),
                rng.normal(2000, 200), rng.normal(1700, 100),
                rng.normal(1000, 80), rng.normal(15, 3),
                rng.normal(2600, 100), rng.normal(280, 20),
            ]
        elif at == 1:
            # Memory leak
            anomaly[i] = [
                rng.normal(350, 50), rng.normal(6000, 500),
                rng.normal(55, 6), rng.normal(92, 2),
                rng.normal(1200, 100), rng.normal(400, 40),
                rng.normal(300, 30), rng.normal(4, 1),
                rng.normal(800, 50), rng.normal(160, 15),
            ]
        elif at == 2:
            # Network flood
            anomaly[i] = [
                rng.normal(4500, 300), rng.normal(200, 50),
                rng.normal(85, 5), rng.normal(60, 5),
                rng.normal(300, 50), rng.normal(4500, 200),
                rng.normal(4500, 200), rng.normal(2, 1),
                rng.normal(4000, 200), rng.normal(250, 30),
            ]
        elif at == 3:
            # Disk thrashing
            anomaly[i] = [
                rng.normal(600, 100), rng.normal(3000, 400),
                rng.normal(60, 10), rng.normal(50, 8),
                rng.normal(15000, 500), rng.normal(100, 30),
                rng.normal(150, 30), rng.normal(8, 2),
                rng.normal(300, 50), rng.normal(500, 60),
            ]
        else:
            # Error burst
            anomaly[i] = [
                rng.normal(3000, 300), rng.normal(1500, 200),
                rng.normal(90, 4), rng.normal(80, 4),
                rng.normal(1000, 150), rng.normal(600, 80),
                rng.normal(500, 70), rng.normal(45, 5),
                rng.normal(1200, 100), rng.normal(400, 40),
            ]
