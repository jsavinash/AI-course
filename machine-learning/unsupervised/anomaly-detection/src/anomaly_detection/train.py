...
def main():
    ...
    parser.add_argument("--threshold-method", type=str, default=os.getenv("THRESHOLD_METHOD", "percentile"))
    parser.add_argument("--threshold-percentile", type=float, default=float(os.getenv("THRESHOLD_PERCENTILE", "95")))
    parser.add_argument("--threshold-iqr-multiplier", type=float, default=float(os.getenv("THRESHOLD_IQR_MULTIPLIER", "1.5")))
