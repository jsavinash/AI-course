...
class AttentionModel:
    ...
    encoder_rnn: np.ndarray = field(default=None, repr=False)
    encoder_b: np.ndarray = field(default=None, repr=False)
    decoder_rnn: np.ndarray = field(default=None, repr=False)
    decoder_b: np.ndarray = field(default=None, repr=False)
    attn: object = field(default=None, repr=False)
    W_out: np.ndarray = field(default=None, repr=False)
    b_out: np.ndarray = field(default=None, repr=False)
