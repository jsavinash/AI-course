...
from mlops_shared.validation import DataValidator, create_video_surveillance_schema
from pydantic import BaseModel, Field

from video_surveillance.data import IMAGE_SIZE, N_CHANNELS, generate_synthetic_data
