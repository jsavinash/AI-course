...
Binary facial recognition for phone unlock and photo tagging
...
## Training
```bash
facial_recognition-train --model-dir ./artifacts/models --n-iterations 300 --n-samples 500
```

## Serving API
```bash
uvicorn facial_recognition.api:app --host 0.0.0.0 --port 8007
```
