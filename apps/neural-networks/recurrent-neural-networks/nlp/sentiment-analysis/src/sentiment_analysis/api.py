...
from mlops_shared.validation import DataValidator, create_sentiment_analysis_schema
from pydantic import BaseModel, Field

from sentiment_analysis.data import SEQ_LEN, VOCAB_SIZE, generate_synthetic_data
