...
from mlops_shared.validation import DataValidator, create_language_translation_schema
from pydantic import BaseModel, Field

from language_translation.data import SEQ_LEN, VOCAB_SIZE, generate_synthetic_data
