...
| `SemanticSegmentationDN` | _build, fit, predict, predict_proba, mse, rmse, evaluate, save, load, to_dict | Deconvolutional network for semantic segmentation.  Args:     img_size: Size of input images (square)     n_channels: Number of input/output channels     n_filters: Number of filters in conv layers     kernel_size: Convolution kernel size     learning_rate: Gradient descent step size     n_iterations: Number of training epochs     weight_decay: L2 regularization strength     random_seed: Random seed |
...
### `SemanticSegmentationDN.fit(X, y, X_val, y_val)`
...
### `SemanticSegmentationDN.predict(X)`
...
from advanced_semantic_segmentation.data import reshape_image
...
```
"""Training pipeline for Semantic Segmentation (DN)."""
...
```
"""Data loading and preprocessing for Semantic Segmentation (DN).
...
```
"""Serving API for Semantic Segmentation (DN)."""
