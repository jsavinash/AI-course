...
![Capsule Neural Network (CapsNet) diagram](./assets/capsnet-autonomous-driving.png)
...
### `AutonomousDrivingCapsNet.fit(X, y, X_val, y_val)`
...
### `AutonomousDrivingCapsNet.predict(X)`
...
```
"""Training pipeline for Autonomous Driving Object Recognition (CapsNet)."""
...
```
"""Data loading and preprocessing for Autonomous Driving Object Recognition (CapsNet).
