...
<title>capsnet-autonomous-driving - AI App Documentation</title>
...
<pre class="ascii-diagram">  AutonomousDrivingCapsNet</pre>
</div>
...
from capsnet_autonomous_driving.data import (
    load_training_data,
    save_training_data,
    train_test_split,
)
...
def train(
    ...
    &quot;&quot;&quot;Train the autonomous driving object recognition model and save artifacts.&quot;&quot;&quot;
    X, y = load_training_data(data_path, n_samples=n_samples, random_seed=random_seed)
    logger.info(&quot;Loaded training data&quot;, n_samples=len(X), data_path=str(data_path))

    if &quot;classification&quot; in (&quot;classification&quot;, &quot;binary_classification&quot;):
        validator = DataValidator(create_autonomous_driving_schema())
    ...
    model_path = model_dir / f&quot;autonomous_driving_model_v{model_version}.npz&quot;
    ...
    registry.save_model(
        ...
        artifacts={
            f&quot;autonomous_driving_model_v{model_version}.npz&quot;: model_path,
            &quot;training_data.npz&quot;: model_dir / &quot;training_data.npz&quot;,
        },
        tags={&quot;framework&quot;: &quot;numpy&quot;, &quot;task&quot;: &quot;autonomous_driving&quot;, &quot;model_type&quot;: &quot;CapsNet&quot;},
    )
    ...
    if register_to_mlflow:
        registry.log_to_mlflow(
            ...
            artifacts={
                ...
                &quot;chart&quot;: str(model_dir / f&quot;autonomous_driving_v{model_version}.png&quot;),
            },
            tags={&quot;model_type&quot;: &quot;autonomous_driving&quot;, &quot;framework&quot;: &quot;numpy&quot;},
        )
        logger.info(&quot;Registered model to MLflow&quot;, model=&quot;autonomous-driving&quot;, version=model_version)
...
def _save_chart(model, output_dir: Path, version: str) -&gt; None:
    ...
    ax.set_ylabel(&quot;Loss&quot;)
    ax.set_title(&quot;Autonomous Driving Object Recognition CapsNet Training Loss&quot;)
    ax.grid(True, alpha=0.3)
    ax.set_yscale(&quot;log&quot;)
    plt.tight_layout()
    chart_path = output_dir / f&quot;autonomous_driving_v{version}.png&quot;
...
def main():
    parser = argparse.ArgumentParser(description=&quot;Train Autonomous Driving Object Recognition model&quot;)
...
<li><a href="../capsnet-text-recognition/README.md">capsnet-text-recognition</a></li></ul>
</div>
</main>
<footer class="app-footer">
<p>Generated documentation for <strong>capsnet-autonomous-driving</strong></p>
</footer>
<script>
