...
![Convolutional Neural Network diagram](./assets/cnn-medical-imaging.png)
...
### `MedicalImagingCNN.fit(X, y, X_val, y_val)`
...
### `MedicalImagingCNN.predict(X, threshold)`
...
```
"""Medical Imaging Diagnosis using a Convolutional Neural Network.
...
from cnn_medical_imaging.data import reshape_image

@dataclass
class MedicalImagingCNN:
    """CNN for medical imaging diagnosis.
    ...
    @classmethod
    def load(cls, path: str) -> "MedicalImagingCNN":
