...
```bash
uv run python -m autoencoders_dimensionality_reduction.train --model-dir ./artifacts/models
```
...
Generated documentation for **autoencoders-dimensionality-reduction**
